...
utilities._requestSubResource = function _requestSubResource(request, info, type, proxiedValues) {
  ...
  // add on the values that we want to proxy onto the subresources
  hrefParameters = _.assign(hrefParameters, proxiedValues);
